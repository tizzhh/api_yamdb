# Generated by Django 3.2 on 2024-03-09 15:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(default=1, validators=[django.core.validators.MinValueValidator(1, 'Оценка не может быть ниже 1.'), django.core.validators.MaxValueValidator(10, 'Оценка не может быть выше 10.')], verbose_name='Оценка')),
        ...
        migrations.AddConstraint(
            model_name='title',
            constraint=models.CheckConstraint(check=models.Q(year__lte=2024), name='Год выпуска не может быть больше текущего'),
        ),
        migrations.AddConstraint(
            model_name='review',
